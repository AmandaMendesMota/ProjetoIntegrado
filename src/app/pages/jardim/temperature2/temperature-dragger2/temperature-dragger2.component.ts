...
@Component({
  selector: 'ngx-temperature-dragger2',
  templateUrl: './temperature-dragger2.component.html',
  styleUrls: ['./temperature-dragger2.component.scss'],
})
export class TemperatureDragger2Component implements AfterViewInit, OnChanges {
  ...
  private invalidate(): void {
    this.bottomAngleRad = TemperatureDragger2Component.toRad(this.bottomAngle);
    this.calculateVars();
