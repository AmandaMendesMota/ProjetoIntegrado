...
@Component({
  selector: 'ngx-temperature-dragger3',
  templateUrl: './temperature-dragger3.component.html',
  styleUrls: ['./temperature-dragger3.component.scss'],
})
export class TemperatureDragger3Component implements AfterViewInit, OnChanges {
  ...
  private invalidate(): void {
    this.bottomAngleRad = TemperatureDragger3Component.toRad(this.bottomAngle);
    this.calculateVars();
